...
set interfaces ethernet eth0 vif 832 dhcp-options client-option "send rfc3118-auth $LIVEBOX_AUTH;"
set interfaces ethernet eth0 vif 832 dhcp-options client-option "send dhcp-client-identifier 1:$LIVEBOX_MAC;"
